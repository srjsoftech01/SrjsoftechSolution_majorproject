...
const WhatsAppChatButton = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-[100] bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg flex items-center justify-center transition-all duration-300 border-2 border-white"
