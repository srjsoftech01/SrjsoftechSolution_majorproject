...
const stats = [
  {
    icon: "🌐",
    number: "43%",
    label: "Websites Built on WordPress",
  },
  {
    icon: "⚙️",
    number: "100+",
    label: "Plugins Integrated",
  },
  {
    icon: "🚀",
    number: "99%",
...
const WordPressStats = () => {
  return (
    <section className="bg-gradient-to-br from-indigo-50 via-white to-blue-50 py-10">
