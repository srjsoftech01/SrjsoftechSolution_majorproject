...
const WhatsAppAdStats = () => {
  return (
    <section className="bg-gradient-to-br from-green-50 via-white to-emerald-50 py-10">
...
export default WhatsAppAdStats;
